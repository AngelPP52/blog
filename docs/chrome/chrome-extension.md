...
<img src="./images/click-option-page.png" alt="click-option-page" style="zoom: 80%;" />
...
<img src="./images/open-chrome-extensions.png" alt="start a chrome etension" style="zoom: 50%;" />
